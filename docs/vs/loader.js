...
!function (e) {
  var t = function () {
    ...
    return t.prototype._init = function (e) {
      ...
      var s = this, d = r.getConfig().getOptionsLiteral(), a = d.nodeRequire || e.global.nodeRequire,
...
!function (e) {
  ...
  var r = function () {
    ...
    return t._safeInvokeFunction = function (t, r) {
      ...
      i && n.onError({
        errorCode: "factory", moduleId: this.strId,
        detail: i
  ...
  var s = function () {
    ...
    return s.prototype.reset = function () {
      ...
      for (var e = [], t = 0, r = 0, n = this._modules2.length; r < n; r++) {
        ...
        if (o) {
          var i = this._buildInfoPath[o.id] || null, d = this._buildInfoDefineStack[o.id] || null,
      ...
      if (r >= 0) {
        var n = t.resolveModule(e.substr(0, r)), s = t.resolveModule(e.substr(r + 1)),
          d = this._moduleIdProvider.getModuleId(n + "!" + s), a = this._moduleIdProvider.getModuleId(n);
        return new i(d, a, s)
      }
