...
class Collection extends __WEBPACK_IMPORTED_MODULE_0__event_emitter__["a" /* LokiEventEmitter */] {
  ...
  add(obj) {
    ...
    try {
      ...
      return (this.cloneObjects) ? (Object(__WEBPACK_IMPORTED_MODULE_5__clone__["a" /* clone */])(obj, this.cloneMethod)) : (obj);
    } catch (err) {
      this.rollback();
      this.console.error(err.message);
      this.emit("error", err);
  ...
  calculateRangeStart(prop, val, adaptive) {
    ...
    while (min < max) {
      ...
      if (Object(__WEBPACK_IMPORTED_MODULE_6__helper__["c" /* ltHelper */])(rcd[index[mid]][prop], val, false)) {
        min = mid + 1;
      } else {
        max = mid;
      }
    ...
    // found it... return it
    if (Object(__WEBPACK_IMPORTED_MODULE_6__helper__["a" /* aeqHelper */])(val, rcd[index[lbound]][prop])) {
      return lbound;
    }

    // if not in index and our value is less than the found one
    if (Object(__WEBPACK_IMPORTED_MODULE_6__helper__["c" /* ltHelper */])(val, rcd[index[lbound]][prop], false)) {
  ...
  calculateRangeEnd(prop, val) {
    ...
    while (min < max) {
      ...
      if (Object(__WEBPACK_IMPORTED_MODULE_6__helper__["c" /* ltHelper */])(val, rcd[index[mid]][prop], false)) {
        max = mid;
      } else {
        min = mid + 1;
      }
    ...
    if (Object(__WEBPACK_IMPORTED_MODULE_6__helper__["a" /* aeqHelper */])(val, rcd[index[ubound]][prop])) {
      return ubound;
    }

    // if not in index and our value is less than the found one
    if (Object(__WEBPACK_IMPORTED_MODULE_6__helper__["b" /* gtHelper */])(val, rcd[index[ubound]][prop], false)) {
      return ubound + 1;
    }

    // either hole or first nonmatch
    if (Object(__WEBPACK_IMPORTED_MODULE_6__helper__["a" /* aeqHelper */])(val, rcd[index[ubound - 1]][prop])) {
      return ubound - 1;
    }
  ...
  calculateRange(op, prop, val) {
    ...
    switch (op) {
      case "$eq":
      case "$aeq":
        if (Object(__WEBPACK_IMPORTED_MODULE_6__helper__["c" /* ltHelper */])(val, minVal, false) || Object(__WEBPACK_IMPORTED_MODULE_6__helper__["b" /* gtHelper */])(val, maxVal, false)) {
          return [0, -1];
        }
        break;
      case "$dteq":
      ...
      case "$gt":
        ...
        if (Object(__WEBPACK_IMPORTED_MODULE_6__helper__["b" /* gtHelper */])(val, maxVal, true)) {
          return [0, -1];
        }
        // all are within range
        if (Object(__WEBPACK_IMPORTED_MODULE_6__helper__["b" /* gtHelper */])(minVal, val, false)) {
          return [min, max];
        }
        break;
      case "$gte":
        // none are within range
        if (Object(__WEBPACK_IMPORTED_MODULE_6__helper__["b" /* gtHelper */])(val, maxVal, false)) {
          return [0, -1];
        }
        // all are within range
        if (Object(__WEBPACK_IMPORTED_MODULE_6__helper__["b" /* gtHelper */])(minVal, val, true)) {
          return [min, max];
        }
        break;
      case "$lt":
        // none are within range
        if (Object(__WEBPACK_IMPORTED_MODULE_6__helper__["c" /* ltHelper */])(val, minVal, true)) {
          return [0, -1];
        }
        // all are within range
        if (Object(__WEBPACK_IMPORTED_MODULE_6__helper__["c" /* ltHelper */])(maxVal, val, false)) {
          return [min, max];
        }
        break;
      case "$lte":
        // none are within range
        if (Object(__WEBPACK_IMPORTED_MODULE_6__helper__["c" /* ltHelper */])(val, minVal, false)) {
          return [0, -1];
        }
        // all are within range
        if (Object(__WEBPACK_IMPORTED_MODULE_6__helper__["c" /* ltHelper */])(maxVal, val, true)) {
          return [min, max];
        }
        break;
      case "$between":
        // none are within range (low range is greater)
        if (Object(__WEBPACK_IMPORTED_MODULE_6__helper__["b" /* gtHelper */])(val[0], maxVal, false)) {
          return [0, -1];
        }
        // none are within range (high range lower)
        if (Object(__WEBPACK_IMPORTED_MODULE_6__helper__["c" /* ltHelper */])(val[1], minVal, false)) {
          return [0, -1];
        }
        ...
        if (!Object(__WEBPACK_IMPORTED_MODULE_6__helper__["b" /* gtHelper */])(rcd[index[lbound]][prop], val[0], true)) lbound++;
        if (!Object(__WEBPACK_IMPORTED_MODULE_6__helper__["c" /* ltHelper */])(rcd[index[ubound]][prop], val[1], true)) ubound--;
    ...
    switch (op) {
      ...
      case "$dteq":
        ...
        //  return [0, -1];
        //}
        if (!Object(__WEBPACK_IMPORTED_MODULE_6__helper__["a" /* aeqHelper */])(lval, val)) {
          return [0, -1];
        }
      ...
      case "$gt":
        ...
        if (!Object(__WEBPACK_IMPORTED_MODULE_6__helper__["a" /* aeqHelper */])(rcd[index[ubound]][prop], val)) {
      ...
      case "$gte":
        ...
        if (!Object(__WEBPACK_IMPORTED_MODULE_6__helper__["a" /* aeqHelper */])(rcd[index[lbound]][prop], val)) {
  ...
  by(field, value) {
    ...
    if (!this.cloneObjects) {
      ...
      return Object(__WEBPACK_IMPORTED_MODULE_5__clone__["a" /* clone */])(result, this.cloneMethod);
    }
  }
  ...
  startTransaction() {
    if (this.transactional) {
      this.cachedData = Object(__WEBPACK_IMPORTED_MODULE_5__clone__["a" /* clone */])(this.data, this.cloneMethod);
...
const LokiOps = {
  ...
  $dteq(a, b) {
    return Object(__WEBPACK_IMPORTED_MODULE_3__helper__["a" /* aeqHelper */])(a, b);
  },

  $gt(a, b) {
    return Object(__WEBPACK_IMPORTED_MODULE_3__helper__["b" /* gtHelper */])(a, b, false);
  },

  $gte(a, b) {
    return Object(__WEBPACK_IMPORTED_MODULE_3__helper__["b" /* gtHelper */])(a, b, true);
  },

  $lt(a, b) {
    return Object(__WEBPACK_IMPORTED_MODULE_3__helper__["c" /* ltHelper */])(a, b, false);
  },

  $lte(a, b) {
    return Object(__WEBPACK_IMPORTED_MODULE_3__helper__["c" /* ltHelper */])(a, b, true);
  },

  // ex : coll.find({'orderCount': {$between: [10, 50]}});
  $between(a, vals) {
    if (a === undefined || a === null) return false;
    return (Object(__WEBPACK_IMPORTED_MODULE_3__helper__["b" /* gtHelper */])(a, vals[0], true) && Object(__WEBPACK_IMPORTED_MODULE_3__helper__["c" /* ltHelper */])(a, vals[1], true));
  },
...
class Resultset {
  ...
  transform(transform, parameters) {
    ...
    if (typeof parameters !== "undefined") {
      transform = Object(__WEBPACK_IMPORTED_MODULE_2__utils__["b" /* resolveTransformParams */])(transform, parameters);
    }
  ...
  data({forceClones, forceCloneMethod = this.collection.cloneMethod, removeMeta = false} = {}) {
    ...
    if (!this.filterInitialized) {
      if (this.filteredrows.length === 0) {
        ...
        if (this.collection.cloneObjects || forceClones) {
          ...
          for (i = 0; i < len; i++) {
            obj = Object(__WEBPACK_IMPORTED_MODULE_0__clone__["a" /* clone */])(data[i], method);
            if (removeMeta) {
              delete obj.$loki;
              delete obj.meta;
            }
    ...
    if (this.collection.cloneObjects || forceClones) {
      method = forceCloneMethod;
      for (i = 0; i < len; i++) {
        obj = Object(__WEBPACK_IMPORTED_MODULE_0__clone__["a" /* clone */])(data[fr[i]], method);
        if (removeMeta) {
          delete obj.$loki;
          delete obj.meta;
        }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__event_emitter__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__resultset__ = __webpack_require__(3);
